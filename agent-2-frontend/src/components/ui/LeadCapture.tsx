...
export default function LeadCapture({ schoolId, buildingId }: LeadCaptureProps) {
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-xl p-5 text-center">
        ...
        <p className="text-sm text-green-700 mt-1">
          We&apos;ll send your free layout guide to that email.
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
      <p className="font-semibold text-base mb-1">Get Your Free Layout Guide</p>
      <p className="text-sm text-gray-600 mb-4">
        We&apos;ll send you a room layout checklist sized exactly for this dorm.
      </p>
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <button
          ...
          className="bg-blue-600 text-white py-3 rounded-lg font-semibold text-base disabled:opacity-60"
        >
